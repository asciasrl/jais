...
public class BentelKyo8 extends BentelKyoUnit {
	...
	@Override
	protected boolean updateRealTime(BentelKyoConnector connector, Vector<Integer> response) {
	...
	@Override
	protected boolean updateStatus(BentelKyoConnector connector, Vector<Integer> response) {
