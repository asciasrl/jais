...
/**
 * Corsi Component Category Model
 *
 * @version		1.0
 * @package		Archibit
 * @subpackage	Corsi
 * @since		1.0
 */
class CorsiModelCategory extends JModel
{
	/**
	 * Category id
	 *
	...
	function __construct()
	{
		...
		$this->setState('limit', $mainframe->getUserStateFromRequest('com_corsi.limit', 'limit', $config->getValue('config.list_limit'), 'int'));
	...
	/**
	 * Method to get a pagination object of the corsi items for the category
	 *
	 * @access public
	 * @return integer
	 */
	...
	function _buildQuery()
	{
		...
		// We need to get a list of all corsi in the given category
		$query = 'SELECT *' .
			' FROM #__corsi' .
