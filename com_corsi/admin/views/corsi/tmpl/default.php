...
<?php
	...
	JToolBarHelper::title(   JText::_( 'Gestione Corsi' ), 'generic.png' );
...
<div id="editcell">
	...
	for ($i=0, $n=count( $this->items ); $i < $n; $i++)
	{
		...
		$link 	= JRoute::_( 'index.php?option=com_corsi&view=corso&task=edit&cid[]='. $row->id );

		$checked 	= JHTML::_('grid.checkedout',   $row, $i );
		$published 	= JHTML::_('grid.published', $row, $i );

		$row->cat_link 	= JRoute::_( 'index.php?option=com_categories&section=com_corsi&task=edit&type=other&cid[]='. $row->catid );
		?>
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
				...
				?>
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'Modifica Corso' );?>::<?php echo $this->escape($row->title); ?>">
