...
<%
// TODO require_once("config.php");
// TODO require_once("custom/config.php");

/*
 * Stiamo su un iPod/iPhone?
 */
String userAgent = request.getHeader("User-Agent");
boolean mobile = (userAgent.indexOf("iPod") != -1) ||
...
<div style="margin: 0px auto; width: 598px; height: 743px;">
	...
	<div style="z-index: 2; position: absolute; margin-left: 139px; margin-top: 107px;">
		...
		<iframe width="<%= IPOD_VIEWPORT_WIDTH %>" 
			...
			style="position:absolute; background-color: black;" src='aui.jsp'>
		</iframe>
